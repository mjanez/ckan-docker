...
ckan config-tool $CKAN_INI \
    ...
    "schemingdcat.social_github=$CKANEXT__SCHEMINGDCAT__SOCIAL_GITHUB" \
    "schemingdcat.social_x=$CKANEXT__SCHEMINGDCAT__SOCIAL_X" \
    "schemingdcat.social_linkedin=$CKANEXT__SCHEMINGDCAT__SOCIAL_LINKEDIN"
